...
public class Measurement extends AppCompatActivity implements View.OnClickListener, Animation.AnimationListener, CompoundButton.OnCheckedChangeListener {
    ...
    private void secondCardImplementation() {
        ...
        tvDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DatePickerDialog(com.healthiera.mobile.fragment.Schedule.Measurement.this, listener,
                        calendar.get(
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(com.healthiera.mobile.fragment.Schedule.Measurement.this);
        ...
        button3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder dialog = new AlertDialog.Builder(com.healthiera.mobile.fragment.Schedule.Measurement.this);
